...
<div class="row">
	<div class="col-sm-12" style="color:Green; margin-top:50px">
...
<button type="button" style="font-size:7pt;color:Green;border:2px solid #336600;padding:3px">Strongly Agree 5</button>
<button type="button" style="font-size:7pt;color:Green;border:2px solid #336600;padding:3px">Agree 4</button>
<button type="button" style="font-size:7pt;color:black;border:2px solid #336600;padding:3px">Neutral 3</button>
<button type="button" style="font-size:7pt;color:red;border:2px solid #336600;padding:3px"> Disagree 2</button>
<button type="button" style="font-size:7pt;color:red;border:2px solid #336600;padding:3px">Strongly Disagree 1</button><br>
